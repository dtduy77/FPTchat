  ...
  return (
    <div className="login-container">
      <div className="login-box">
        <img src="src/assets/fptlogo.png" alt="Logo" className="logo" />
        <h2>Chào mừng đến với ChatFPT</h2>
        <div className="login-form-horizontal">
          <div className="email-login">
            <input type="email" placeholder="Nhập địa chỉ Email*" className="input-field" />
          ...
          <div className="social-login">
            ...
            <button className="social-btn facebook-btn">
              <i className="fab fa-facebook facebook-icon"></i> Tiếp tục với Facebook
            </button>
            <button className="social-btn microsoft-btn">
              <i className="fab fa-microsoft microsoft-icon"></i> Tiếp tục với Microsoft
            </button>
          </div>
        </div>
        <p className="terms">
